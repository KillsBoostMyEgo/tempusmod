...
import tempussmpmods3.procedures.CHIKENProcedure;
...
public class ChickenEntity extends TempusModElements.ModElement {
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(1f, 0.7f)).build("chicken")
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onCollideWithPlayer(PlayerEntity sourceentity) {
			...
			double z = this.getPosZ();
			{
				...
				CHIKENProcedure.executeProcedure($_dependencies);
			}
		}
