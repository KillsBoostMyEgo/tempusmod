...
public class DiamondNetheriteGui extends TempusModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public DiamondNetheriteGui(TempusModElements instance) {
		super(instance, 59);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("diamond_netherite"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("tempus:textures/diamond_netherite.png");
		@Override
