...
import tempussmpmods3.procedures.InfusionStationUpdateTickProcedure;
...
public class InfusionGui extends TempusModElements.ModElement {
	...
	public InfusionGui(TempusModElements instance) {
		super(instance, 114);
		...
		if (buttonID == 0) {
			{
				...
				InfusionStationUpdateTickProcedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 1) {
			{
