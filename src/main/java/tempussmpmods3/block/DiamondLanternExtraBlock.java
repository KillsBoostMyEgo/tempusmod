...
public class DiamondLanternExtraBlock extends TempusModElements.ModElement {
	@ObjectHolder("tempus:diamond_lantern_extra")
	public static final Block block = null;
	public DiamondLanternExtraBlock(TempusModElements instance) {
		super(instance, 17);
	}
