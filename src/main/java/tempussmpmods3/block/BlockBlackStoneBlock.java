...
public class BlockBlackStoneBlock extends TempusModElements.ModElement {
	@ObjectHolder("tempus:block_black_stone")
	public static final Block block = null;
	public BlockBlackStoneBlock(TempusModElements instance) {
		super(instance, 34);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("block_black_stone");
		}
